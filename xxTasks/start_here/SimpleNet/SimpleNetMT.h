...
public:
	...
	public:
		...
		Connection(Connection&& a_other) noexcept;
		Connection& operator=(Connection&& a_other) noexcept;
...
private:
	...
	static const OutputsQ::value_type &GetShutdownPoisionedApple();
	static OutputsQ::value_type GetConnectionPoisionedApple(SocketId a_socketId);
