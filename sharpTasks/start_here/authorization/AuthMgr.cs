...
namespace AuthorizationNS
{
    public static class AuthMgr
    {
        ...
        public static Authorization GetAuthorization(Pii<string> a_username, ILogger a_logger)
        {
            ...
            try
            {
                ...
                foreach (string a_line in lines)
                {
                    ...
                    else if (string.IsNullOrEmpty(a_parts[0]) || a_parts[0] == a_username.ExposeUnsecured())
                    {
